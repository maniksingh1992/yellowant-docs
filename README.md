# YellowAnt API OpenAPI Specification
[![Build Status](https://travis-ci.org/maniksingh1992/yellowant-docs.svg?branch=master)](https://travis-ci.org/maniksingh1992/yellowant-docs)
...
6. If you did everything correct, https://maniksingh1992.github.io/yellowant-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://maniksingh1992.github.io/yellowant-docs/
- SwaggerUI: https://maniksingh1992.github.io/yellowant-docs/swagger-ui/
- Look full spec:
    + JSON https://maniksingh1992.github.io/yellowant-docs/swagger.json
    + YAML https://maniksingh1992.github.io/yellowant-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://maniksingh1992.github.io/yellowant-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://maniksingh1992.github.io/yellowant-docs/ with url from the message: `Server started <url>`
